...
def get_args_parser():
    parser = argparse.ArgumentParser('ViT, DeiT, and Seg-ViT training and evaluation script', add_help=False)
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'CIFAR-SEG'],
