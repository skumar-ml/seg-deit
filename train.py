# Adapted from Facebook's DeIT (https://github.com/facebookresearch/deit)
...
def get_args_parser():
    parser = argparse.ArgumentParser(
        "SegVIT training and evaluation script", add_help=False
    )
    ...
    parser.add_argument(
        ...
        default=True,
        type=bool,
        help="If img should convert to grayscale before taking FT. Else, FT of RGB channels taken separetely and concat",
    )
    parser.add_argument(
        "--n_points",
        default=64,
        type=int,
        help="Number of points to use in N-point FFT",
    )
    parser.add_argument(
        "--num_tokens",
        default=196,
...
def main(args):
    ...
    world_size = (
        1  # TODO: Check if this needs to be updated to be the number of GPUs in use
    )
    ...
    # wrap the criterion in our custom DistillationLoss, which just dispatches to the original criterion if args.distillation_type is 'none'
